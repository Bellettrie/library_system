# Generated by Django 5.1.4 on 2025-03-08 20:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication_title_secondary_text', models.TextField(default='')),
                ...
                ('search_words', models.TextField(default='')),
                ('creator_text', models.TextField(default='')),
                ('series_text', models.TextField(default='')),
                ('series_parents_text', models.TextField(default='')),
...
alter table search_searchrecord
 add all_text_search_vector tsvector
     generated always as 
     (
         setweight(to_tsvector('simple', coalesce(search_words, '')), 'A'):: tsvector || ' ' ||
         ...
         setweight(to_tsvector('simple', coalesce(series_text, '')), 'B') :: tsvector  || ' ' ||
         setweight(to_tsvector('simple', coalesce(series_parents_text, '')), 'C') :: tsvector  || ' ' ||
         ...
         setweight(to_tsvector('simple', coalesce(publication_title_secondary_text, '')), 'D') :: tsvector  || ' ' ||
