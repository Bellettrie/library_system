# Generated by Django 5.1.4 on 2025-03-04 19:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_text', models.TextField(default='')),
            ...
            options={
                'indexes': [django.contrib.postgres.indexes.GinIndex(fields=['all_text'], name='searchV_all', opclasses=['gin_trgm_ops'])],
            },
        ),
        migrations.RunSQL("""
         ...
         add all_text_search_vector tsvector
             generated always as (
                 ...
                 setweight(to_tsvector('simple', coalesce(publication_creator_text, '')), 'B') :: tsvector  || ' ' ||
                 setweight(to_tsvector('simple', coalesce(publication_series_text, '')), 'B') :: tsvector  || ' ' ||
