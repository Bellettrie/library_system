...
def show_row(book_result, is_even_row, perms, user, member):
    return {"publication": book_result.publication, "item_rows": book_result.item_rows,
            "item_options": book_result.item_options, "is_even_row": is_even_row,
            "is_single_item_row": len(book_result.item_rows) == 1, "perms": perms, "user": user, "member": member}
