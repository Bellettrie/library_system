...
from .views import show_members_by_date, show_members_by_group, show_membership_stats, show_lending_stats

urlpatterns = [
    path('member_filtered/date_based', show_members_by_date, name='datamining.members.date_based'),
    path('member_filtered/special', show_members_by_date, name='datamining.members.special'),
