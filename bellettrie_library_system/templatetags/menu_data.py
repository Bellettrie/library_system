...
def get_menu_item_list():
    ...
    my_menu.append(
        MenuItem("Our Activities", reverse('named_page', args=(settings.STANDARD_PAGE_GROUP, 'member',)), None, 'top',
                 [],
                 icon='fa fa-user', anonymous=True))
    my_menu.append(
        MenuItem('Become a member', reverse('named_page', args=(settings.STANDARD_PAGE_GROUP, 'member',)), None, 'top',
                 [], anonymous=True,
                 icon='fa fa-user'))
    my_menu.append(
        MenuItem("Become Active", reverse('named_page', args=(settings.STANDARD_PAGE_GROUP, 'member',)), None, 'top',
                 [],
                 icon='fa fa-user', anonymous=True))

    my_menu.append(
        MenuItem('Board / Committees', reverse('named_page', args=(settings.STANDARD_PAGE_GROUP, 'committees',)), None,
                 'top-left', [],
                 icon='fa fa-users'))
    my_menu.append(
    ...
    my_menu.append(
        MenuItem('About', reverse('named_page', args=(settings.STANDARD_PAGE_GROUP, 'about',)), None, 'top-right', [],
                 icon='fa fa-user'))
    my_menu.append(
        MenuItem('Contact', reverse('named_page', args=(settings.STANDARD_PAGE_GROUP, 'contact',)), None, 'top-right',
                 [],
                 icon='fa fa-info'))
