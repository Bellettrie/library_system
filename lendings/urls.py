...
urlpatterns = [
    ...
    path('member/<int:member_id>', member_based, name='lendings.member.viewmber.new'),
    path('item/<int:item_id>/new', item_based, name='lendings.item.new'),
    ...
    path('item/<int:item_id>/return/', hx_wrap(return_item), name='lendings.item.returnbook'),
